    ...
    <div className="bg-[#121212] h-fit w-full text-white md:pt-36 md:pb-20 lg:pt-2 lg:px-24 -mt-1">
      <div className="md:pt-4 mx-4 md:mx-4 lg:mx-8 pb-20">
        ...
        <ul className="text-[#9BA1A7] list-none list-inside mt-4 text-xl">
          ...
          <li className="mt-2 text-white">
            Yes. But due to security reasons, we will only launch it after the
            sale period ends.
          </li>
          ...
          <li className="mt-2 text-white">
            A: We have reserved 50 NFTs for future giveaways.
          </li>
          <li className="mt-8">Q: Will the NFTs be revealed instantly?</li>
          <li className="mt-2 text-white">A: Yes.</li>
          <li className="mt-8">Q: Is the NFT distribution random?</li>
          <li className="mt-2 text-white">
            A: Yes. Everyone will receive random NFTs.
          </li>
